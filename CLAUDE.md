...
- **Drum loops** (`audio/drums-{bpm}.m4a`, 60/88/96/108/120): 17-bar cuts from `~/Music/Logic/Drum Beats/Bounces/Loops/` (bars 1–16 loop, bar 17 is natural tail), loudness-matched to −16 LUFS, 128k AAC. The grooves are humanised (bars correlate ~0.7–0.9), so loops of 4/8/16 bars keep the feel. David has said the beats can be public.
