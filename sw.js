...
const VERSION = 'backtrack-v10';
const AUDIO = 'backtrack-audio-v1';
const SHELL = ['./', 'index.html', 'manifest.webmanifest', 'js/app.js', 'js/audio.js', 'js/clock.js', 'js/groove.js', 'js/lab.js', 'js/rec.js', 'js/rec-worklet.js', 'js/state.js', 'js/takes.js', 'js/ui.js',
